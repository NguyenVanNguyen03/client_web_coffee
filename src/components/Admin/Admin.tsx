            ...
            <div className="container_manage-product">
                ...
                <div className="add-product">
                    <div>
                        ...
                        <input type="text" id="created_at" placeholder="Created At" value={newProductData.created_at} onChange={(e) => setNewProductData({ ...newProductData, created_at: e.target.value })} />

                        <label htmlFor="updated_at">Updated At:</label>
                        <input type="text" id="updated_at" placeholder="Updated At" value={newProductData.updated_at} onChange={(e) => setNewProductData({ ...newProductData, updated_at: e.target.value })} />

                        <label htmlFor="deleted_at">Deleted At:</label>
                        <input type="text" id="deleted_at" placeholder="Deleted At" value={newProductData.deleted_at} onChange={(e) => setNewProductData({ ...newProductData, deleted_at: e.target.value })} />
